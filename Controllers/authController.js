class AuthController {
    ...
    static register(username, password, email, role = 'customer',firstName,lastName,contact,addresses) {

        const users = User.getUsers();
        const newUser = new User(users.length + 1, username, password, email, role, firstName, lastName, contact, addresses);
    ...
    static submitSellerRegRequest(username, password, email,firstName, lastName,contact,addresses){
        ...
        const newSellerReq = new Seller(sellerReqs.length + 1, username, password, email,firstName, lastName,contact,addresses, dateOfRequest); // r(id, username, password, email, role, date, contact, fullName)
