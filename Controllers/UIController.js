  ...
  static renderWishlist() {
    ...
    if (user && user.role !== "admin") {
      ...
      if (wishlistItems.length > 0) {
        ...
        productsContainer.innerHTML = `<div class="d-flex flex-column align-items-center mt-5"><h5 style="color: #888"; class='text-center mt-2 '>You haven't added any items to your wishlist.</h5> <i style='font-size: 17rem; color: #eee'; class='bi bi-heart'></i></div>`;
      }
    } else {
      productsContainer.innerHTML = `<div class="d-flex flex-column align-items-center mt-5"><h5 style="color: #888"; class='text-center mt-2 '>Please login as a customer to view your wishlist</h5> <i style='font-size: 17rem; color: #eee'; class='bi bi-heart'></i></div>`;
    }
  }
}
